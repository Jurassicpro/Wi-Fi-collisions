...
QT_MOC_LITERAL(1, 7, 20), // "btnMouseReleaseEvent"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 15) // "Qt::MouseButton"

    },
    "Button\0btnMouseReleaseEvent\0\0"
    "Qt::MouseButton"
};
...
void Button::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->btnMouseReleaseEvent((*reinterpret_cast< Qt::MouseButton(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Button::*)(Qt::MouseButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Button::btnMouseReleaseEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Button::btnMouseReleaseEvent(Qt::MouseButton _t1)
{
