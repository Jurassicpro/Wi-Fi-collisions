...
QT_MOC_LITERAL(1, 3, 19), // "PCMouseReleaseEvent"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 15) // "Qt::MouseButton"

    },
    "PC\0PCMouseReleaseEvent\0\0Qt::MouseButton"
};
...
void PC::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->PCMouseReleaseEvent((*reinterpret_cast< Qt::MouseButton(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (PC::*)(Qt::MouseButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PC::PCMouseReleaseEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PC::PCMouseReleaseEvent(Qt::MouseButton _t1)
{
