...
QT_MOC_LITERAL(1, 7, 23), // "RouterMouseReleaseEvent"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 15) // "Qt::MouseButton"

    },
    "Router\0RouterMouseReleaseEvent\0\0"
    "Qt::MouseButton"
};
...
void Router::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->RouterMouseReleaseEvent((*reinterpret_cast< Qt::MouseButton(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Router::*)(Qt::MouseButton );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Router::RouterMouseReleaseEvent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Router::RouterMouseReleaseEvent(Qt::MouseButton _t1)
{
